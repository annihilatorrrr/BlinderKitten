...
public:
    ...
    enum ActionType { FX_START, FX_STOP, FX_SIZE, FX_FLASH, FX_SWOP, FX_SPEED, FX_DOUBLESPEED, FX_HALFSPEED, FX_TAPTEMPO, FX_TOGGLE, FX_BBW, FX_STOP_INSTANT, FX_SET_SEEK, FX_ADD_SEEK, FX_SEEK };
